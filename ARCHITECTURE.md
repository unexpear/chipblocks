...
frontend/test/        vitest, 150 tests, ~9 s
  ...
  blocks.test.tsx               block render + parameter editing + range validation (80 tests across all 40 blocks)
