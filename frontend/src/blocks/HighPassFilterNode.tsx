...
export type HighPassFilterBlock = Node<{ cutoff_hz: number }, 'highpass'>

export function HighPassFilterNode({ id, data }: NodeProps<HighPassFilterBlock>) {
  ...
  return (
    <div className="block block-highpass" role="group" aria-labelledby={titleId}>
      <Handle type="target" position={Position.Left} id="audio-in" aria-label="Audio input" />
      <h3 id={titleId} className="block-title">High-pass</h3>
