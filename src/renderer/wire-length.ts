...
import { awgAreaM2, awgDiameterM, COPPER_RESISTIVITY_OHM_M, INCH_M } from '../wire-gauge.ts'

// The AWG conductor geometry + copper resistivity live in the shared wire-gauge module
// (so the motor winding's resistance uses the same source); re-exported for callers.
export { awgAreaM2, COPPER_RESISTIVITY_OHM_M }
