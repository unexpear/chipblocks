...
export const PARTS: { definition: string; label: string }[] = [
  ...
  { definition: 'block_divider', label: 'Divider' },
  { definition: 'block_led_r', label: 'LED + R' },
  { definition: 'block_rc_lowpass', label: 'RC LPF' },
  { definition: 'block_ce_amp', label: 'CE Amp' },
  { definition: 'block_bridge', label: 'Bridge' },
  { definition: 'block_noninv_amp', label: 'Non-inv Amp' },
  ...
  { definition: 'logic_decoder_2_4', label: '2-4 Dec' },
  { definition: 'logic_decoder_3_8', label: '3-8 Dec' },
  { definition: 'logic_encoder_4_2', label: '4-2 Enc' },
  { definition: 'logic_encoder_8_3', label: '8-3 Enc' },
  ...
  { definition: 'display_separator', label: 'Separator' },
  { definition: 'dot_matrix_5x7', label: 'Dot Matrix 5×7' },
  { definition: 'dot_matrix_mux_8x8', label: 'LED Matrix 8×8' },
  { definition: 'dot_matrix_mux_16x16', label: 'LED Matrix 16×16' },
  { definition: 'dot_matrix_rgb_7x7', label: 'RGB Matrix 7×7' },
  { definition: 'glyph_rom_5x7', label: 'Glyph ROM' },
  { definition: 'active_matrix_pixel', label: 'AM Pixel' },
  { definition: 'row_scanner_8', label: 'Row Scan 8' },
  { definition: 'row_scanner_16', label: 'Row Scan 16' },
  { definition: 'row_scanner_32', label: 'Row Scan 32' },
  ...
  { definition: 'logic_bcd_adder', label: 'BCD Adder' },
  { definition: 'logic_bcd_adder_10', label: 'BCD Adder ×10' },
  { definition: 'logic_bcd_complementer', label: 'BCD 9s-Comp' },
  { definition: 'logic_bcd_alu_cell', label: 'BCD ALU Cell' },
  { definition: 'logic_bcd_alu_10', label: 'BCD ALU ×10' },
  { definition: 'logic_bcd_decoder_10', label: 'BCD Decoder ×10' },
