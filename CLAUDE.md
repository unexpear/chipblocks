...
- [LEGAL-CONSIDERATIONS.md](LEGAL-CONSIDERATIONS.md) — legal posture review (not legal advice): license/bundling, copyright (facts vs expression), trademark (needs USPTO check before launch), patent considerations, AI-generated content responsibility, warranty/liability, export control, privacy. Risk-by-category summary. Reviewed 2026-06-05.
- [LICENSE](LICENSE) — MIT
